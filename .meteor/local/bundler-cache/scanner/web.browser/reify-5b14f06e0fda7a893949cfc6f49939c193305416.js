let defaults,remove,splitAndCapture;module.link("./utils",{defaults(v){defaults=v},remove(v){remove=v},splitAndCapture(v){splitAndCapture=v}},0);let AnchorTagBuilder;module.link("./anchor-tag-builder",{AnchorTagBuilder(v){AnchorTagBuilder=v}},1);let Match;module.link("./match/match",{Match(v){Match=v}},2);let EmailMatch;module.link("./match/email-match",{EmailMatch(v){EmailMatch=v}},3);let HashtagMatch;module.link("./match/hashtag-match",{HashtagMatch(v){HashtagMatch=v}},4);let MentionMatch;module.link("./match/mention-match",{MentionMatch(v){MentionMatch=v}},5);let PhoneMatch;module.link("./match/phone-match",{PhoneMatch(v){PhoneMatch=v}},6);let UrlMatch;module.link("./match/url-match",{UrlMatch(v){UrlMatch=v}},7);let Matcher;module.link("./matcher/matcher",{Matcher(v){Matcher=v}},8);let HtmlTag;module.link("./html-tag",{HtmlTag(v){HtmlTag=v}},9);let EmailMatcher;module.link("./matcher/email-matcher",{EmailMatcher(v){EmailMatcher=v}},10);let UrlMatcher;module.link("./matcher/url-matcher",{UrlMatcher(v){UrlMatcher=v}},11);let HashtagMatcher;module.link("./matcher/hashtag-matcher",{HashtagMatcher(v){HashtagMatcher=v}},12);let PhoneMatcher;module.link("./matcher/phone-matcher",{PhoneMatcher(v){PhoneMatcher=v}},13);let MentionMatcher;module.link("./matcher/mention-matcher",{MentionMatcher(v){MentionMatcher=v}},14);let parseHtml;module.link('./htmlParser/parse-html',{parseHtml(v){parseHtml=v}},15);
...
module.exportDefault(Autolinker);
