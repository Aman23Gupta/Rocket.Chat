...
var Description = function () {
    ...
    var listItem = function (text) { return (_jsxs(List.Item, __assign({ fontScale: 'p1' }, { children: [_jsx(Icon, { name: 'check', size: 'x24', mie: 'x12' }, void 0), text] }), void 0)); };
    return (_jsx(Box, { children: _jsx(Box, { children: _jsx(List, __assign({ color: color, spacing: 'x16', icon: icon }, { children: featuresList.map(function (text) { return listItem(text); }) }), void 0) }, void 0) }, void 0));
};
