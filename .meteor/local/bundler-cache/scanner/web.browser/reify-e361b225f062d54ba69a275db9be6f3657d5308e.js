...
var OrganizationInfoForm = function (_a) {
    ...
    return (_jsxs(Form, __assign({ onSubmit: handleSubmit(onSubmit) }, { children: [_jsx(Form.Steps, { currentStep: currentStep, stepCount: stepCount }, void 0), _jsx(Form.Title, { children: t('form.organizationInfoForm.title') }, void 0), _jsx(Form.Subtitle, { children: t('form.organizationInfoForm.subtitle') }, void 0), _jsx(Form.Container, { children: _jsxs(FieldGroup, { children: [_jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: organizationNameField }, { children: t('form.organizationInfoForm.fields.organizationName.label') }), void 0), _jsx(Field.Row, { children: _jsx(TextInput, __assign({}, register('organizationName', { required: true }), { placeholder: t('form.organizationInfoForm.fields.organizationName.placeholder'), id: organizationNameField }), void 0) }, void 0), errors.organizationName && (_jsx(Field.Error, { children: t('component.form.requiredField') }, void 0))] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: organizationTypeField }, { children: t('form.organizationInfoForm.fields.organizationType.label') }), void 0), _jsx(Field.Row, { children: _jsx(Controller, { name: 'organizationType', control: control, render: function (_a) {
                                        ...
                                        } }, void 0) }, void 0)] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: organizationIndustryField }, { children: t('form.organizationInfoForm.fields.organizationIndustry.label') }), void 0), _jsx(Field.Row, { children: _jsx(Controller, { name: 'organizationIndustry', control: control, render: function (_a) {
                                            var field = _a.field;
                                        ...
                                        } }, void 0) }, void 0)] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: organizationSizeField }, { children: t('form.organizationInfoForm.fields.organizationSize.label') }), void 0), _jsx(Field.Row, { children: _jsx(Controller, { name: 'organizationSize', control: control, render: function (_a) {
                                            var field = _a.field;
                                        ...
                                        } }, void 0) }, void 0)] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: countryField }, { children: t('form.organizationInfoForm.fields.country.label') }), void 0), _jsx(Field.Row, { children: _jsx(Controller, { name: 'country', control: control, render: function (_a) {
                                            var field = _a.field;
                                        ...
                                        } }, void 0) }, void 0)] }, void 0)] }, void 0) }, void 0), _jsx(Form.Footer, { children: _jsxs(ButtonGroup, __assign({ vertical: isMobile, flexGrow: 1 }, { children: [_jsx(Button, __assign({ disabled: isSubmitting, onClick: onBackButtonClick }, { children: t('component.form.action.back') }), void 0), _jsx(Button, __assign({ type: 'submit', primary: true, disabled: isValidating || isSubmitting }, { children: nextStep !== null && nextStep !== void 0 ? nextStep : t('component.form.action.next') }), void 0), onClickSkip && (_jsx(Box, __assign({ withTruncatedText: true, flexGrow: 1 }, { children: _jsx(ButtonGroup, __assign({ flexGrow: 1, align: 'end' }, { children: _jsx(Button, __assign({ nude: true, info: true, onClick: onClickSkip }, { children: t('component.form.action.skip') }), void 0) }), void 0) }), void 0))] }), void 0) }, void 0)] }), void 0));
};
