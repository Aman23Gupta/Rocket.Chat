...
var CreateFirstMemberForm = function (_a) {
    ...
    return (_jsxs(Form, __assign({ onSubmit: handleSubmit(onSubmit) }, { children: [_jsx(Form.Steps, { currentStep: currentStep, stepCount: stepCount }, void 0), _jsx(Form.Title, { children: t('form.createFirstMemberForm.title') }, void 0), _jsx(Form.Subtitle, { children: t('form.createFirstMemberForm.subtitle', { workspaceName: workspaceName }) }, void 0), _jsxs(FieldGroup, __assign({ mbs: 'x16' }, { children: [_jsxs(Field, { children: [_jsx(Field.Label, { children: _jsx(Box, __assign({ display: 'inline', mie: 'x8' }, { children: t('form.createFirstMemberForm.fields.username.label') }), void 0) }, void 0), _jsx(Field.Row, { children: _jsx(TextInput, __assign({ error: ((_b = errors === null || errors === void 0 ? void 0 : errors.username) === null || _b === void 0 ? void 0 : _b.type) || undefined }, register('username', { required: true })), void 0) }, void 0), errors.username && (_jsx(Field.Error, { children: t('component.form.requiredField') }, void 0))] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, { children: t('form.createFirstMemberForm.fields.password.label') }, void 0), _jsx(Field.Row, { children: _jsx(PasswordInput, __assign({}, register('password', {
                                    validate: validatePassword,
                                    required: true,
                                })), void 0) }, void 0), errors.password && (_jsx(Field.Error, { children: errors.password.message }, void 0))] }, void 0)] }), void 0), _jsx(Form.Footer, { children: _jsxs(ButtonGroup, { children: [_jsx(Button, __assign({ disabled: isSubmitting, onClick: onBackButtonClick }, { children: t('component.form.action.back') }), void 0), _jsx(Button, __assign({ type: 'submit', primary: true, disabled: isValidating || isSubmitting || !isValid }, { children: t('form.createFirstMemberForm.button.submit') }), void 0)] }, void 0) }, void 0)] }), void 0));
};
