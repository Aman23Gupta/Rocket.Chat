...
var PreviewBlock = function (_a) {
    ...
    return (react_1.default.createElement(fuselage_1.Box, null,
        react_1.default.createElement(fuselage_1.MessageGenericPreview, null,
            (0, ui_kit_1.isPreviewBlockWithPreview)(block) && ((_b = block.preview) === null || _b === void 0 ? void 0 : _b.dimensions) && (react_1.default.createElement(fuselage_1.MessageGenericPreviewImage, { width: block.preview.dimensions.width, height: block.preview.dimensions.height, url: block.preview.url })),
            react_1.default.createElement(fuselage_1.MessageGenericPreviewContent, { thumb: (0, ui_kit_1.isPreviewBlockWithThumb)(block) ? (react_1.default.createElement(fuselage_1.MessageGenericPreviewThumb, null,
                    react_1.default.createElement(fuselage_1.MessageGenericPreviewImage, { height: 192, width: 368, url: block.thumb.url }))) : undefined },
                Array.isArray(block.title) ? (react_1.default.createElement(fuselage_1.MessageGenericPreviewTitle, { externalUrl: (0, ui_kit_1.isPreviewBlockWithPreview)(block) ? block.externalUrl : undefined }, block.title.map(function (title) {
