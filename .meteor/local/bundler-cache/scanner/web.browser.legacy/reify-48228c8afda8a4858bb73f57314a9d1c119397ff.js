...
var Description = function () {
    ...
    var listItem = function (text) { return (jsx_runtime_1.jsxs(List_1.default.Item, __assign({ fontScale: 'p1' }, { children: [jsx_runtime_1.jsx(fuselage_1.Icon, { name: 'check', size: 'x24', mie: 'x12' }, void 0), text] }), void 0)); };
    return (jsx_runtime_1.jsx(fuselage_1.Box, { children: jsx_runtime_1.jsx(fuselage_1.Box, { children: jsx_runtime_1.jsx(List_1.default, __assign({ color: color, spacing: 'x16', icon: icon }, { children: featuresList.map(function (text) { return listItem(text); }) }), void 0) }, void 0) }, void 0));
};
