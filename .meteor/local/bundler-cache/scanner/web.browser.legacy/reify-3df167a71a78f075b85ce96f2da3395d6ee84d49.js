...
exports.kitContext = (0, react_1.createContext)(exports.defaultContext);
var useUiKitContext = function () { return (0, react_1.useContext)(exports.kitContext); };
exports.useUiKitContext = useUiKitContext;
var useUiKitStateValue = function (actionId, initialValue) {
    var _a, _b;
    var _c = (0, exports.useUiKitContext)(), values = _c.values, errors = _c.errors;
    return {
