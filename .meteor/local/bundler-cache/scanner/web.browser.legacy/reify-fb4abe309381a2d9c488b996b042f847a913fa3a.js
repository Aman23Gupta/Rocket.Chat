...
var MultiStaticSelectElement = function (_a) {
    ...
    return (react_1.default.createElement(fuselage_1.MultiSelectFiltered, { value: value, disabled: loading, error: error, options: options, placeholder: (0, fromTextObjectToString_1.fromTextObjectToString)(surfaceRenderer, block.placeholder, 0), onChange: handleChange }));
};
