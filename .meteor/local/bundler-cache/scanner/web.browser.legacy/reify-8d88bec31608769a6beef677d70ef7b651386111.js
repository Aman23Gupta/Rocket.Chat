...
var LinearScaleElement = function (_a) {
    ...
    var _d = (0, useUiKitState_1.useUiKitState)(block, context), _e = _d[0], loading = _e.loading, _f = _e.value, value = _f === void 0 ? initialValue : _f, error = _e.error, action = _d[1];
