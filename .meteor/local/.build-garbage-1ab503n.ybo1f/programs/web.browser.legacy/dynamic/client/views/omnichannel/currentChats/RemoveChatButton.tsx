...
var RemoveChatButton = function (_ref) {
  var _id = _ref._id,
      reload = _ref.reload;
  var removeChat = useMethod('livechat:removeRoom');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _regeneratorRuntime.awrap(removeChat(_id));
...
//# sourceMappingURL=/dynamic/client/views/omnichannel/currentChats/883f94a311353ab1f054a8cac4c8a10350bd4a0a.map
