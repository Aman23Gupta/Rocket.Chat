...
function CustomUserStatusRoute() {
  var route = useRoute('custom-user-status');
  var context = useRouteParameter('context');
  var id = useRouteParameter('id');
  var canManageUserStatus = usePermission('manage-user-status');
...
//# sourceMappingURL=/dynamic/client/views/admin/customUserStatus/98a9a312abb8caa668cf4d75ff412cb37f2e37b9.map
