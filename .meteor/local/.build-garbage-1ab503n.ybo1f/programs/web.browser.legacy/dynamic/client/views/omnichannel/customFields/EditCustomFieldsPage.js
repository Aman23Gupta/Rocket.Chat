...
var Box, Button, Icon, ButtonGroup, FieldGroup;
...
var getInitialValues = function (cf) {
  return {
    id: cf._id,
    field: cf._id,
    label: cf.label,
...
var EditCustomFieldsPage = function (_ref) {
  ...
  var _useForm = useForm(getInitialValues(customField)),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _regeneratorRuntime.awrap(save(id, _objectSpread(_objectSpread(_objectSpread({}, additionalData), values), {}, {
...
//# sourceMappingURL=/dynamic/client/views/omnichannel/customFields/deba5e5782be431acee54aec5e828aa4c7b3f99c.map
