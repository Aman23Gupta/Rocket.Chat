...
var useAutoFocus, useMediaQuery;
...
function TeamsTable() {
  ...
  var header = useMemo(function () {
    ...
    }, t('Created_at'))].filter(Boolean);
  }, [sort, onHeaderClick, t, mediaQuery]);
  var channelsRoute = useRoute('channel');
  var groupsRoute = useRoute('group');
  var query = useQuery(params, sort, 'teams');
  ...
  var renderRow = useCallback(function (team) {
    var _id = team._id,
        ts = team.ts,
        t = team.t,
        name = team.name,
        fname = team.fname,
        topic = team.topic,
        roomsCount = team.roomsCount;
    var avatarUrl = roomTypes.getConfig(t).getAvatarPath(team);
...
//# sourceMappingURL=/dynamic/client/views/directory/44e6a95256d34b15894b38a6b2d77d7bcdca4a62.map
