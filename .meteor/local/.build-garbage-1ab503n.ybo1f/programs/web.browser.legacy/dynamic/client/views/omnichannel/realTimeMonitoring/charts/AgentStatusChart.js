...
var labels = ['Available', 'Away', 'Busy', 'Offline'];
var initialData = {
  available: 0,
  away: 0,
  busy: 0,
...
var init = function (canvas, context, t) {
  return drawDoughnutChart(canvas, t('Agents'), context, labels.map(function (l) {
    return t(l);
  }), Object.values(initialData));
};

var AgentStatusChart = function (_ref) {
  ...
  var _useEndpointData = useEndpointData('livechat/analytics/dashboards/charts/agents-status', params),
  ...
  var _ref2 = data !== null && data !== void 0 ? data : initialData,
      _ref2$offline = _ref2.offline,
      offline = _ref2$offline === void 0 ? 0 : _ref2$offline,
      _ref2$available = _ref2.available,
      available = _ref2$available === void 0 ? 0 : _ref2$available,
      _ref2$away = _ref2.away,
      away = _ref2$away === void 0 ? 0 : _ref2$away,
      _ref2$busy = _ref2.busy,
      busy = _ref2$busy === void 0 ? 0 : _ref2$busy;
...
//# sourceMappingURL=/dynamic/client/views/omnichannel/realTimeMonitoring/charts/229c1849eea4fbeb7fe1acd3d3460e467467beff.map
