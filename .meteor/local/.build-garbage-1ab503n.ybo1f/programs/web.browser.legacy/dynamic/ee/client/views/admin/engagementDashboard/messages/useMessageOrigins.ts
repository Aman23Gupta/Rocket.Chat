...
module.export({
  useMessageOrigins: function () {
    return useMessageOrigins;
  }
});
var useQuery;
...
var useMessageOrigins = function (_ref) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _regeneratorRuntime.awrap(getFromRestApi('/v1/engagement-dashboard/messages/origin')({
...
//# sourceMappingURL=/dynamic/ee/client/views/admin/engagementDashboard/messages/598a625feb16d56eadcd5c834506b35618c37762.map
