...
var RemoveUnitButton;
module.link("./RemoveUnitButton", {
  "default": function (v) {
    RemoveUnitButton = v;
  }
}, 9);
var UnitEditWithData;
...
function UnitsRoute() {
  ...
  var canViewUnits = usePermission('manage-livechat-units');
  ...
  var _useEndpointData = useEndpointData('livechat/units.list', query),
...
//# sourceMappingURL=/dynamic/ee/client/omnichannel/units/ae12c269c4d48ba3a0ac2b68b4503c2c7cc6d0db.map
